...
const TRANSLATIONS = {
  en: {
    ...
    "content.notif.edit_title_required": "Title is required.",
    ...
    "help.getting_started_body": "<ul><li><strong>Connect</strong> &mdash; Join the <strong>Lumina Hub</strong> Wi-Fi hotspot broadcast by the Hub laptop. Password: <strong>lumina2026</strong>.</li><li><strong>Install the app</strong> &mdash; On the welcome page, download the EduMesh APK and install it on your Android phone. Enable \"Install from Unknown Sources\" if prompted.</li><li><strong>Register</strong> &mdash; Open the app, choose a username and password (8+ characters with uppercase, lowercase, and a number). Then set up your profile with your display name and grade.</li><li><strong>Start learning</strong> &mdash; Browse textbooks, videos, and other resources. Download them to use offline.</li></ul>",
    ...
    "students.sort_at_risk": "At-risk (Inactive first)",
    "students.at_risk_days_label": "Inactive >",
    "students.days": "days",
    ...
    "welcome.guide.download_offline_body": "Tap the download icon on any resource to save it to your phone. Downloaded resources work <strong>even when you’re not connected</strong> to the Lumina Hub. Perfect for studying anywhere.",
    ...
    "welcome.guide.getting_started_body": "<li><strong>Connect to Wi-Fi</strong> -- Turn on your phone's Wi-Fi and join the network named <strong>Lumina Hub</strong>. Password: <strong>lumina2026</strong>.</li><li><strong>Open the welcome page</strong> -- Open your browser and go to <strong>http://10.42.0.1:8000</strong>.</li><li><strong>Download the app</strong> -- Tap the <strong>Download App</strong> button in the top-right corner of this page to get the EduMesh APK.</li><li><strong>Install the app</strong> -- Open the downloaded file and tap Install. If your phone asks, allow “Install from Unknown Sources” in Settings.</li><li><strong>Register</strong> -- Open the EduMesh app, tap <strong>Enter Portal</strong>, choose a <strong>username</strong> and <strong>password</strong> (8+ characters with uppercase, lowercase, and a number).</li><li><strong>Set up your profile</strong> -- Enter your display name and select your grade.</li><li><strong>Start learning</strong> -- Browse textbooks, videos, past papers, and more. Tap any resource to view it, or download it to access offline.</li>",
    ...
    "welcome.connection_title": "Connection Info",
    "welcome.wifi_network": "WiFi Network",
    "welcome.hub_address": "Hub Address",
    ...
    "content.quiz.title_required": "Title is required.",
    ...
    "settings.default_admin_title": "Default Admin Account",
    "settings.status_label": "Status:",
    "settings.default_admin_self_warning_title": "You cannot disable the default admin while logged into it",
    "settings.default_admin_self_warning_body": "Log in with a different admin account first, then disable the default admin from that account. This prevents accidental lockout.",
    "settings.default_admin_risk_title": "Risks of disabling the default admin",
    "settings.default_admin_risk_1": "The built-in admin account (username: admin) will be permanently blocked from login.",
    "settings.default_admin_risk_2": "If all other teacher accounts are deleted or locked, the hub will be inaccessible.",
    "settings.default_admin_risk_3": "Re-enabling requires physical access to the server or the Settings page from another admin account.",
    "settings.disable_default_admin_btn": "Disable Default Admin",
    "settings.enable_default_admin_btn": "Re-enable Default Admin",
    "settings.severity_all": "All Severity",
    "settings.severity_info": "Info",
    "settings.severity_notice": "Notice",
    "settings.severity_warning": "Warning",
    "settings.severity_error": "Error",
    "settings.severity_critical": "Critical",
    "settings.results_all": "All Results",
    "settings.results_success": "Success",
    "settings.results_failed": "Failed",
    "settings.search_logs_label": "Search logs",
    "settings.log_no_details": "No additional details",
    "settings.chip_severity": "Severity: ",
    "settings.chip_success_only": "Success only",
    "settings.chip_failed_only": "Failed only",
    "settings.chip_user": "User: ",
    "settings.chip_search": "Search: ",
    "settings.no_matching_logs": "No matching log entries",
